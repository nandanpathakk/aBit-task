...
function Dashboard() {
    return (
        <div className="flex gap-[255px] mt-[147px] ml-[93px] mr-[122px]">
            <div>
                <p className="text-[28px]/[33.59px]">Releases</p>
                <p className="">Videos that you upload in collaboration with aBit appear here.</p>
            </div>
            <div className="grid grid-cols-4 text-[#696969] text-[14px]/[22.4px]">
