    ...
    return (
        <div>
            <div className="flex justify-between h-[110px] border border-black bg-[url('/src/assets/images/header-bg.jpeg')] bg-cover z-20">
                <div className="my-[40px] ml-[123px] text-2xl/[29.05px] font-bold font-['inter']">
                    aBit
                </div>
                <div className="flex items-center gap-[16px] mr-[54px]">
                    <div className="text-xs/[14.09px] font-bold font-['Raleway'] text-[#764CC2] border-2 border-[#764CC2] rounded-[60px] bg-cover bg-norepeat px-[22px] py-[12.5px] my-[35px] flex flex-cols justify-center">
                        share new video
                    </div>
